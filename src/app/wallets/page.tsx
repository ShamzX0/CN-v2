    ...
    return <>
        ...
        <div className="container w-full md:max-w-4xl mx-auto pt-26 text-[#cccbcb]">
            ...
            <div className="w-full mt-10 px-4 md:px-6 text-l leading-normal">
                ...
                {/* <!--Title--> */}
                <div>
                    <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl text-white">Everything you need to<br /> know about <span className="underline underline-offset-3 decoration-8 decoration-[#208282]"><br />Hardware Wallets</span></h1>
                ...
                {/* SUB HEADER 1 */}
                <h5 className="mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-4xl lg:text-4xl text-white"><span className="underline underline-offset-3 decoration-8 decoration-[#208282]"><br /> What are hardware wallets? </span></h5>
                ...
                {/* SUBH HEADER 2 */}
                <h5 className="mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-4xl lg:text-4xl text-white"><span className="underline underline-offset-3 decoration-8 decoration-[#208282]"><br />Swiss Bank in your pocket !</span></h5>
                ...
                <p className="py-6">In addition to the aforementioned benefits, it is crucial to emphasize the importance of keeping track of your passwords and securely storing them! When using a hardware wallet, it is common to have a recovery seed phrase—a series of words that acts as a backup to restore your wallet in case of loss or damage. This seed phrase should be treated with the utmost care and stored in a secure location, preferably offline and away from prying eyes.
                    ...
                    <h1 className="border-l-4 border-[#208282] neon-writing font-medium text-xl italic my-8 pl-8 md:pl-12">NOT YOUR KEYS, NOT YOUR CRYPTO!</h1>
                ...
                {/* SUBH EADER 3 */}
                <h5 className="mb-8 text-4xl mt-10 font-extrabold leading-none tracking-tight md:text-4xl lg:text-5xl text-white">A Deep Dive into the <br />Pros & Cons of 3<span className="underline underline-offset-3 decoration-8 decoration-[#208282]"><br />Popular Hardware Wallets<br /></span></h5>
                ...
                <h5 className="mb-4 py-6 text-2xl font-extrabold leading-none tracking-tight md:text-4xl lg:text-2xl text-white"><span># 1</span><span className="border-l-4 ml-4 border-[#208282]  text-xl italic my-2 pl-8 md:pl-12 ">Ledger Nano X Hardware Wallet </span></h5>
                ...
                <h5 className="mb-4 py-6 text-2xl font-extrabold leading-none tracking-tight  md:text-4xl lg:text-2xl text-white"><span># 2</span><span className="border-l-4 ml-4 border-[#208282] text-xl italic my-2 pl-8 md:pl-12 ">Trezor One Hardware Wallet</span></h5>
                <div className='flex justify-center'>
                ...
                <h5 className="mb-4 py-6 text-2xl font-extrabold leading-none tracking-tight  md:text-4xl lg:text-2xl text-white"><span># 3</span><span className="border-l-4 ml-4 border-[#208282] text-xl italic my-2 pl-8 md:pl-12 ">BitBox02 Hardware Wallet</span></h5>
                <div className='flex justify-center'>
            ...
            <Link
                href="/"
                className="neon-card border-opacity-30 text-white/80 hover:text-[#f4f4f4] py-2 px-4 ml-11 rounded font-unbounded font-light transition duration-200 ease-in-out hover:[box-shadow:0_0_20px_#00d9ff,0_0_20px_#00d9ff,0_0_20px_#00d9ff]"
            >
                Home Page
            </Link>
        </div >
